...
class RequestPreferencesPage: AtwUIViewController, BackendCallback {
    ...
    @IBAction func updateButtonClickAction(sender: UIButton) {
        ...
        let quantityItem = (numberOfResponsesTextField.inputView as! SelectorView).getSelectedItems()[0];
        let waitTimeItem = (waitTimeTextField.inputView as! SelectorView).getSelectedItems()[0];
