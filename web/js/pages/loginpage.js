...
LoginPage.prototype.definePageContent = function(root) {
  ...
  contentPanel.appendChild(UIUtils.createLabeledInputField("LoginPage-Login", "Email (login)", "10px"));
  contentPanel.appendChild(UIUtils.createLineBreak());
  contentPanel.appendChild(UIUtils.createLabeledInputField("LoginPage-Password", "Password", "10px"));
  contentPanel.appendChild(UIUtils.createLineBreak());
