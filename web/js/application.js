 ...
 Application = {
  Configuration: {
    ...
    GENDER_PREFERENCE: [{data: "all", display: I18n.getLocale().literals.GenderPreferenceAny}, {data: "female", display: I18n.getLocale().literals.GenderPreferenceFemale}, {data: "male", display: I18n.getLocale().literals.GenderPreferenceMale}],
