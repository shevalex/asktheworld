...
PisoftToolbar = ClassUtils.defineClass(PisoftContainer, function PisoftToolbar(uniqueId, margin) {
  PisoftContainer.call(this, uniqueId, "pisoft-toolbar pisoft-non-selectable");
  this.leftComponents = [];
